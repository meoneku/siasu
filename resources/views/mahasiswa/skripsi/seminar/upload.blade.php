...
@section('main')
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-horizontal" method="post" action="{{ route('seminar.updateUnggah', encrypt($data->id)) }}" enctype="multipart/form-data" onsubmit="return Animate()">
                    @csrf
                    <div class="form-group row mb-3 mt-3">
                        <label for="file_pembayaran" class="col-sm-2 col-form-label">Bukti Pembayaran Seminar</label>
                        <div class="col-sm-6">
                    ...
                    <div class="form-group row mb-3 mt-3">
                        <label for="file_krs" class="col-sm-2 col-form-label">KRS</label>
                        <div class="col-sm-6">
                            <input type="file" name="file_krs" id="file_krs" class="form-control @error('file_krs') is-invalid @enderror" accept="image/*" onchange="preview2()">
                            <small class="text-muted"><i>* Maksimum Ukuran Bekas 500 kb</i></small><br>
                            @if ($data->file_krs == null or $data->file_krs == '')
