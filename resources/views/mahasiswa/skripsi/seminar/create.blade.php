        ...
        <div class="card">
            @if (empty($batch))
                <div class="card-body">
                    ...
                    <div class="row">
                        <a href="{{ route('seminar.index') }}" class="btn btn-warning"><i class="fa fa-arrow-left"></i> Kembali</a>
                    </div>
                </div>
            @else
                @if (empty($skripsi))
                    <div class="card-body">
                        <div class="alert alert-danger" role="alert">
                            ...
                            <p>
                                1. Pastikan Telah Melakukan Pendaftaran Judul Skripsi<br />
                                2. Pastikan Foto Copy Pendaftaran Telah Di Serahkan Ke Kantor Fakultas Teknik/Prodi<br />
                                3. Pastikan Telah Mendapat Dosen Pembimbing Skripsi<br />
                            </p>
                            <hr>
