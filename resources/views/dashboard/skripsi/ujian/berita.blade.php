        ...
        <table width="850px" class="paragraf">
            ...
            <tr>
                <td colspan="3" class="justify">
                    Pada hari ini {{ \App\Helpers\IndoTanggal::tanggal($seminar->tanggal_seminar) }} jam {{ date('G:i', strtotime($seminar->jam_mulai)) }} - {{ date('G:i', strtotime($seminar->jam_selesai)) }} WIB. Bertempat di ruang {{ $seminar->ruang }} telah dilakukan Seminar Hasil Skripsi :
                </td>
            </tr>
            <tr>
                <td colspan="3">
