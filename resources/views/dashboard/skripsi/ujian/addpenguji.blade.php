    ...
    <div class="col-lg-12">
        <div class="card card-primary card-outline">
            <div class="card-header">
                <h5 class="card-title m-0">Data Pendaftar Seminar Hasil Skripsi | Add Dosen Penguji</h5>
            </div>
            <div class="card-body">
                <form class="form-horizontal" method="post" action="{{ url('webmin/semhas/penguji') . '/' . $seminar->id }}" enctype="multipart/form-data">
                    @csrf
