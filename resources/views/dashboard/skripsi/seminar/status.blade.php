    ...
    <div class="col-lg-12">
        <div class="card card-primary card-outline">
            <div class="card-header">
                <h5 class="card-title m-0">Data Pendaftar Seminar Skripsi | Status Daftar</h5>
            </div>
            <div class="card-body">
                ...
                <form class="form-horizontal" method="post" action="{{ url('webmin/seminar/status') . '/' . $seminar->id }}" enctype="multipart/form-data">
                    @method('put')
                    @csrf
