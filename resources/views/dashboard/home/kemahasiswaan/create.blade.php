...
@section('main')
    <div class="col-lg-12">
        <div class="card card-primary card-outline">
            ...
            <div class="card-body">
                <form method="post" id="form" action="{{ route('kemahasiswaan.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="nm_menu" class="form-control @error('nm_menu') is-invalid @enderror" name="nm_menu" value="{{ old('nm_menu') }}" required>
