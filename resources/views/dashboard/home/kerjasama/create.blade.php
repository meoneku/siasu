            ...
            <div class="card-body">
                <form class="form-horizontal" method="post" action="{{ route('kerjasama.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control @error('nm_instansi') is-invalid @enderror" id="Nama Instansi" name="nm_instansi" placeholder="nm_instansi" value="{{ old('nm_instansi') }}" maxlength="128" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <img id="frame" src="" width="140px" height="auto" style="display:none" />
                        </div>
                    </div>
