...
@section('main')
    <div class="col-lg-12">
        <div class="card card-primary card-outline">
            ...
            <div class="card-body">
                <form class="form-horizontal" method="post" action="{{ url('webmin/homepage/fasilitas') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group row">
                        <label for="deskripsi" class="col-sm-2 col-form-label">Deskripsi</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control @error('deskripsi') is-invalid @enderror" id="deskripsi" name="deskripsi" placeholder="deskripsi" value="{{ old('deskripsi') }}" maxlength="128" required>
                        </div>
                    </div>
                    <div class="form-group row">
