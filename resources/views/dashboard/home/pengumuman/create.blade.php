...
@section('main')
    <div class="col-lg-12">
        <div class="card card-primary card-outline">
            ...
            <div class="card-body">
                <form method="post" id="form" action="{{ route('pengumuman.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        <label for="gambar" class="col-sm-2 col-form-label">File Pengumuman</label>
                        <div class="col-sm-10">
