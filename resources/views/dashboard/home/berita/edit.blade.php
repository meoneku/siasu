...
@section('main')
    <div class="col-lg-12">
        <div class="card card-primary card-outline">
            ...
            <div class="card-body">
                <form method="post" id="form" action="{{ route('berita.update', $berita->slug) }}" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="judul" class="form-control @error('judul') is-invalid @enderror" name="judul" value="{{ old('judul', $berita->judul) }}" required>
                            @error('judul')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="slug" class="form-control @error('slug') is-invalid @enderror" name="slug" value="{{ old('slug', $berita->slug) }}" readonly required>
                            @error('slug')
                                <span class="text-sm text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea id="body" class="form-control @error('body') is-invalid @enderror" name="body" required>{{ old('body', $berita->body) }}</textarea>
                            @error('body')
                                <span class="text-sm text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="penulis" class="form-control @error('penulis') is-invalid @enderror" name="penulis" value="{{ old('penulis', $berita->penulis) }}" required>
                            @error('penulis')
                                <span class="text-sm text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="datetime-local" id="publish_at" class="form-control @error('publish_at') is-invalid @enderror" name="publish_at" value="{{ old('publish_at', $berita->publish_at) }}">
                            @error('publish_at')
                                <span class="text-sm text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="row align-items-center col-sm-8">
                            <div class="form-check form-check-inline">
                                <input type="radio" class="form-check-input" id="draf" name="is_banner" value="no"{{ $berita->is_banner === 'no' ? ' checked' : '' }}>
                                <label class="form-check-label" for="draf">Tidak</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input type="radio" class="form-check-input" id="publish" name="is_banner" value="yes"{{ $berita->is_banner === 'yes' ? ' checked' : '' }}>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <img src="{{ url('uploads') . '/' . $berita->gambar }}" alt="{{ $berita->gambar }}" width="50%" height="auto">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="file" class="col-sm-2 col-form-label">File Berita</label>
                        <div class="col-sm-10">
                            <div class="input-grup">
                                <div class="custom-file">
                            ...
                            @if ($berita->file != null)
                                <br /><a href="{{ url('uploads') . '/' . $berita->file }}" class="btn btn-success"><i class="fas fa-download"></i> Unduh Berkas</a>
                            @endif
                        </div>
                    </div>
