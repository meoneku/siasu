...
@section('main')
    <div class="col-lg-12">
        <div class="card card-primary card-outline">
            ...
            <div class="card-body">
                <form class="form-horizontal" method="post" action="{{ url('webmin/suratobservasi') }}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="redirect_to" value="{{ url('webmin/suratobservasi') }}">
