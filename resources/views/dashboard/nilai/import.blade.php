    ...
    <div class="col-lg-12">
        <div class="card card-primary card-outline">
            <div class="card-header">
                <h5 class="card-title m-0">Import Data Nilai</h5>
            </div>
            <div class="card-body">
                <form action="{{ url('/webmin/nilai/import') }}" method="post" id="import-form" onsubmit="showBar()" enctype="multipart/form-data">
                    @csrf
                ...
                <div class="alert alert-success" role="alert">
                    Import Nilai Pindahan Hanya Bisa Di Gunakan Di Format Export KRS Mahasiswa Pada Feeder
                </div>
            </div>
        </div>
    </div>
