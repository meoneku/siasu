...
@section('main')
    <div class="col-lg-12">
        <div class="card card-primary card-outline">
            ...
            <div class="card-body">
                <form class="form-horizontal" method="post" action="{{ url('webmin/lulusan') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group row">
                        <label for="nim" class="col-sm-2 col-form-label">NIM</label>
                        <div class="col-sm-3">
                            <input type="text" class="form-control @error('nim') is-invalid @enderror" id="nim" name="nim" placeholder="Nomor Induk Mahasiswa" value="{{ old('nim') }}" maxlength="10" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control @error('tempat_lahir') is-invalid @enderror" id="tempat" name="tempat_lahir" placeholder="Tempat Lahir" value="{{ old('tempat_lahir') }}" maxlength="128" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="tanggal" class="col-sm-2 col-form-label">Tanggal Lahir</label>
                        <div class="col-sm-3">
                            <input type="date" class="form-control @error('tanggal_lahir') is-invalid @enderror" id="tanggal" name="tanggal_lahir" value="{{ old('tanggal_lahir') }}"required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <input type="date" class="form-control @error('tanggal_lulus') is-invalid @enderror" id="tanggal_lulus" name="tanggal_lulus" value="{{ old('tanggal_lulus') }}"required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="tanggal_wisuda" class="col-sm-2 col-form-label">Tanggal Wisuda</label>
                        <div class="col-sm-3">
                            <input type="date" class="form-control @error('tanggal_wisuda') is-invalid @enderror" id="tanggal_wisuda" name="tanggal_wisuda" value="{{ old('tanggal_wisuda') }}"required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="pin" class="col-sm-2 col-form-label">PIN</label>
                        <div class="col-sm-4">
                            <input type="number" class="form-control @error('pin') is-invalid @enderror" id="pin" name="pin" placeholder="Penomoran Ijazah Nasional" value="{{ old('pin') }}" maxlength="20" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="nomorijazah" class="col-sm-2 col-form-label">Nomor Ijazah</label>
                        <div class="col-sm-4">
                            <input type="number" class="form-control @error('nomorijazah') is-invalid @enderror" id="nomorijazah" name="nomorijazah" placeholder="Nomor Urut Ijazah" value="{{ old('nomorijazah') }}" maxlength="20" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="judul" class="col-sm-2 col-form-label">Judul Skripsi</label>
                        <div class="col-sm-10">
                            <textarea id="judul" name="judul_skripsi" class="form-control" required>{{ old('judul_skripsi', 'Judul-judulan') }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
