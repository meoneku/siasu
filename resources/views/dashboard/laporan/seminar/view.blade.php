        ...
        <table width="100%" class="paragraf">
            ...
            <tr>
                <td style="text-align:center;">
                    <strong><span style="font-size: 18px">DATA PENDAFTAR SEMINAR SKRIPSI</strong>
                </td>
            </tr>
            {{-- <tr>
                <td style="text-align:center;">
        ...
        <table width="100%" class="jadwal">
            ...
            @foreach ($seminar as $data)
                <tr>
                    ...
                    <td>{{ $data->tanggal_seminar === null ? '' : \App\Helpers\IndoTanggal::tanggal($data->tanggal_seminar) }}</td>
