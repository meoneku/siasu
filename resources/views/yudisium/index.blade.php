...
@section('main')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Pendaftaran Yudisium</li>
        </ol>
    </nav>
    @if (empty($batch))
    ...
    @else
        <div class="alert alert-success" role="alert">
            <h4 class="alert-heading">Syarat Pendaftaran Yudisium</h4>
            <p>
                1. Telah Melunasi Pembayaran Yudisium<br />
                2. Telah Menyelesaikan Sidang/Seminar Hasil Skripsi<br />
                3. Dll
            </p>
            <hr>
        ...
        @endif
        <form class="form-control" method="post" action="/yudisium" enctype="multipart/form-data">
            @csrf
