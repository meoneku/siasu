                    ...
                    <div class="col-lg-8 entries">
                        ...
                        <article class="entry entry-single">
                            ...
                            <div class="entry-meta">
                                <ul>
                                    <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a href="#"><time datetime="{{ $pengumuman->publish_at }}">{{ \App\Helpers\IndoTanggal::tanggal($pengumuman->publish_at, false) }}</time></a></li>
                                </ul>
                            </div>
